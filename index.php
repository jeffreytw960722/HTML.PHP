...
<html>
	...
	<body>
		...
		<!-- Banner -->
			<section id="banner">
			<div class="row">
			<div class="3u">CardNo</div>
            <a class="6u 12u$(xsmall)">
              <input type="text" name="CardNo" id="CardNo" value="" placeholder="CardNo" />
            </a>
			<br/>
			<br/>
			<div class="3u">PassWord</div>
            <a class="6u 12u$(xsmall)">
              <input type="password" name="pwd" id="pwd" value="" placeholder="password" />
            </a>
            <a class="2u 12u$(xsmall)">
			          <button onclick="window.location.href='index2.php'">登入</button>
            </a>
          </div>
				<div class="inner">
				<br/><br/><br/>
