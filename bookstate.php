...
<html>
	...
	<body class="landing">
      ...
      <section id="banner">
							<header class="major ">
					  <form action="bookstate.php" method="GET">
            <div class="row">
            <div class="2u">
								<br>
              </div>
    ...
    <section id="main" class="wrapper">
        ...
        <?php
          function select_example($use)
          {
            ...
            $sql = 	"SELECT a.*, b.*, c.* FROM `book` as a LEFT JOIN `book_authors` as b on a.BookId = b.BookId 
    ...
    {
      echo "<table><tr><th>ISBN</th><th>書名</th><th>作者</th><th>出版社</th></tr>";
      while($row = $result->fetch_assoc())
      {
        echo "<tr><td>".$row["BookId"]."</td><td>".$row["Title"]."</td> <td>".$row["AuthorName"]."</td><td>".$row["PublisherName"]."</td></tr>";
      }
      echo "</table>";
    }
    else
